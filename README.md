...
flowchart TB
    ...
    subgraph CAP["🧰 Capabilities"]
        direction LR
        TOOLS["<b>Tool Registry (37)</b><br/>+ ToolExecutor (single chokepoint)"]
...
| **Tool registry** (typed) + **37 tools** + **ToolExecutor** chokepoint | ✅ |
...
| **Tests** — 173 passing (permissions, router, tools, approvals, orchestrator, API, Phase 2) | ✅ |
