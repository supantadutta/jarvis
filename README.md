...
flowchart TB
    ...
    subgraph CAP["🧰 Capabilities"]
        direction LR
        TOOLS["<b>Tool Registry (42)</b><br/>+ ToolExecutor (single chokepoint)"]
...
| **Tool registry** (typed) + **42 tools** + **ToolExecutor** chokepoint | ✅ |
...
| **Tests** — 287 passing (permissions, router, tools, approvals, orchestrator, API, Phase 2) | ✅ |
